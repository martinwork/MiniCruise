	...
	*/
    ...
    export function playMusic(musicItem:MusicList) : void {
        if(musicItem==MusicList.music1){ // 两只老虎
            ...
            music.playTone(658, music.beat(BeatFraction.Whole))
            music.playTone(523, music.beat(BeatFraction.Whole))
            music.playTone(523, music.beat(BeatFraction.Whole))
            music.playTone(587, music.beat(BeatFraction.Whole))
            music.playTone(658, music.beat(BeatFraction.Whole))
			...
			music.playTone(1047, music.beat(BeatFraction.Double))
			music.playTone(784, music.beat(BeatFraction.Half))
			music.playTone(784, music.beat(BeatFraction.Half))
			music.playTone(1568, music.beat(BeatFraction.Whole))
			music.playTone(1319, music.beat(BeatFraction.Whole))
			music.playTone(1047, music.beat(BeatFraction.Whole))
			...
			music.playTone(1047, music.beat(BeatFraction.Quarter))
			music.playTone(1175, music.beat(BeatFraction.Quarter))
			music.playTone(1047, music.beat(BeatFraction.Quarter))
